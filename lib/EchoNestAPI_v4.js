...
EchoNestAPI_v4.prototype.songs = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};
  
  this.execute('artist', 'songs', ['id','name','results','start'], params, callback);
};

EchoNestAPI_v4.prototype.similar = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};
...
EchoNestAPI_v4.prototype.suggest = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};

  this.execute('artist', 'suggest', ['results','name','q'], params, callback);
}

EchoNestAPI_v4.prototype.terms = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};

  this.execute('artist', 'terms', ['id','name','sort'], params, callback);
}

EchoNestAPI_v4.prototype.top_hottt = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};

  this.execute('artist', 'top_hottt', ['results','start','bucket', 'limit'], params, callback);
}

EchoNestAPI_v4.prototype.top_terms = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};

  this.execute('artist', 'top_terms', ['results'], params, callback);
}

EchoNestAPI_v4.prototype.urls = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};

  this.execute('artist', 'urls', ['id', 'name'], params, callback);
}

EchoNestAPI_v4.prototype.video = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};

  this.execute('artist', 'video', ['id', 'name', 'results', 'start'], params, callback);
}

EchoNestAPI_v4.prototype.song_search = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};
...
EchoNestAPI_v4.prototype.song_profile = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};
  
  this.execute('song', 'profile', ['id', 'bucket','limit' ], params, callback);
};

EchoNestAPI_v4.prototype.identify = function(params, callback) {
  if (typeof params == 'function') callback = params, params = {};
...
EchoNestAPI_v4.prototype.sandbox = function(config) {
  var api = this;
